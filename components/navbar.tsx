...
export default function Navbar() {
  return (
    <nav className="fixed top-0 z-50 w-full shadow-xs">
      <div className="bg-[#23856D] text-white text-sm flex flex-row justify-between px-40 items-center  py-1.5">
      ...
      <div className="bg-white py-2.5 flex flex-row justify-between px-40 items-center font-semibold">
        <p className="font-semibold text-2xl pr-[89px] p-[13px]">Bookstar</p>
        <div className="flex flex-row gap-3.75 text-[#737373]">
          <p>Home</p>
          <p>Shop</p>
          <p>About</p>
          <p>Blog</p>
